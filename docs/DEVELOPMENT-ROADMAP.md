...
| Mobile/web/API/worker              | Mobile MA0–MA6 và MA7 repo hardening hoàn tất; external acceptance chờ API/worker/web, staging, EAS/Sentry/store và thiết bị thật; web/API/worker chưa scaffold | Plan 01–04, 06                                        |
