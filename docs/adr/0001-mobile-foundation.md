...
Workspace DI1 chưa được triển khai đầy đủ.
...
- Tạo workspace pnpm/Turborepo tối thiểu chỉ để sở hữu `apps/mobile`; không coi DI1 đã hoàn tất.
...
- `apps/contact-web`, `apps/api`, `apps/worker`, CI và shared config vẫn thuộc DI1, chưa hoàn tất.
- Source map upload và release tagging cho Sentry thuộc MA7/DI4.
